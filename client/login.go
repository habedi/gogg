...
// It only handles the network communication and returns the new token details.
func PerformTokenRefresh(refreshToken string) (accessToken string, newRefreshToken string, expiresIn int64, err error) {
